package net.kathir.pagination.model
...
import net.kathir.pagination.utils.BASE_URL_API
import net.kathir.pagination.utils.BASE_URL_IMG
...
fun setImageMovie(image: ImageView, imageUrl: String?, progressMovie: ProgressBar)
{
    ...
    Glide.with(image.context).load(url).listener(object : RequestListener<Drawable>{
